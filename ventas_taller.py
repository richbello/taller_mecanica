...
class VentasTaller:
    ...
    def _cargar_fondo(self):
        ruta_fondo = r"C:\RICHARD\RB\2025\Taller_mecánica\panel_de_inicio_fondo.png"
    ...
    def _construir_formulario(self):
        ...
        btn_guardar = ttk.Button(self.content_frame, text="💾 Guardar Venta",
                                 style="Menu.TButton",
