# pasarela_pagos.py
# Versión ajustada: mantiene los colores originales (fondo oscuro y botones naranjas)
# Usa ttk.Button con estilo "Menu.TButton" en lugar de ModernButton para respetar la apariencia previa.
# Sigue integrada con security_core (audit, telemetry) y con la derivación maestra / migración.
...
# ---- UI: Pasarela de Pagos (with original colors preserved) ----
class PasarelaPagos:
    ...
    def _setup_styles(self):
        ...
        # Botones con color naranja y texto oscuro (mantener apariencia original)
    ...
    def _on_process_payment(self):
        ...
        button_clicked("PasarelaPagos", "Procesar pago", f"client={client} amount={amount} token={token or 'direct'}")
